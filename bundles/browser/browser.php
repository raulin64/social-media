<?php
	...
	class Browser {
		...
		*/
		...
		$this->checkBrowsers();
		 $movil = $this->_is_mobile ? "Verdadero" : "Falso";
		//echo '<script>alert (" es un movil? '. $movil . ' $this->_is_mobile; ");</script>';
		...
		*/
		...
		protected function determine() {
			echo '<script>alert (" check Platform '. $this->checkPlatform() . ' checkPlatform ");</script>';
			$this->checkPlatform();
			echo '<script>alert (" check Browsers '. $this->checkBrowsers() . ' checkBrowsers ");</script>';
			$this->checkBrowsers();
	    ...
	    protected function checkBrowserHonor() {
			...
			if (strpos($user_agent, 'Mobile') !== false) {
				...
				//echo '<script>alert (" Se detectó un dispositivo Honor. '. 'Honor' . ' checkPlatform ");</script>';
				return $this->setMobile(true);
			} else {
