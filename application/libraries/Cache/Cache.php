...
class Cache
{
     ...
     */
    public function getOrCreate($filename, $conditions , \Closure $function, $file = false, $actual = false)
    {
        $cacheFile = $this->getCacheFile($filename, true, true);
        $data = null;
     ...
     */
    public function getOrCreateFile($filename, $conditions, \Closure $function, $actual = false)
    {
